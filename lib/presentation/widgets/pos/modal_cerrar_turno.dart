...
class _CerrarTurnoContenidoState extends State<_CerrarTurnoContenido> {
  ...
  Widget build(BuildContext context) {
    return AlertDialog(
      title: const Text('Cierre de Turno (Corte X)', style: TextStyle(color: AppColors.textPrimary)),
      ...
      actions: (_isLoading || _loadingError != null)
          ...
          : [
              ...
              ElevatedButton(
                ...
                child: const Text('Finalizar Turno y Salir'),
              ),
            ],
    );
  }
    ...
    return SizedBox(
      ...
      child: SingleChildScrollView(
        child: Column(
          ...
          children: [
            _buildRow('(+) Fondo Inicial:', _currencyFormat.format(_fondoInicial)),
            _buildRow('(+) Ventas en Efectivo:', _currencyFormat.format(_ventasEfectivo)),
            _buildRow('(+) Ventas con Tarjeta:', _currencyFormat.format(_ventasTarjeta)),
            const Divider(thickness: 1, height: 20),
            _buildRow('(=) Total Esperado en Caja:', _currencyFormat.format(_totalEsperadoEfectivo), isTotal: true),
            const Divider(thickness: 1, height: 20),
            TextFormField(
  ...
  Widget _buildRow(String label, String value, {bool isTotal = false, Color? color}) {
    return Padding(
